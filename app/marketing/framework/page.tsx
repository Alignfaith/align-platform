...
export const metadata: Metadata = {
  ...
  description: 'A deep dive into the Six Pillars of Relationship Fitness — Spiritual, Mental, Physical, Financial, Appearance, and Intimacy. The framework for becoming a ready partner.',
  openGraph: {
...
const pillars = [
  ...
  },
  {
    ...
    description: 'Physical fitness is about how you care for your body through movement, nutrition, rest, and daily habits. This is not about appearance standards — it\'s about honoring the body God gave you and having the energy and vitality to show up fully in relationship.',
    questions: [
  ...
  },
  {
    ...
    questions: [
      ...
      'Am I working toward financial stability, or am I running from financial responsibility?',
      'Do I give generously? Does my spending reflect my values?',
      'Have I had honest conversations with myself about debt, spending habits, and financial goals?',
    ],
  ...
  },
  {
    ...
    description: 'Appearance fitness is about how you carry and present yourself — with dignity, intentionality, and confidence. This is not about vanity or meeting a beauty standard. It\'s about taking care of your presentation as a form of self-respect and consideration for the people you interact with.',
    questions: [
      'Do I invest appropriate care in how I present myself in public and in relationship?',
      'Am I comfortable in my own skin, or do I have unresolved insecurity I carry into relationships?',
      'Do I dress and carry myself in a way that reflects the values I claim to hold?',
      'Am I honest about how my appearance habits (hygiene, grooming, style) may affect others?',
    ],
  ...
  return (
    <>
      ...
      <section style={{ backgroundColor: '#0A0A0B', padding: '80px 24px' }}>
        <div style={{ maxWidth: '840px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '48px' }}>
          {pillars.map((p) => (
            <div key={p.number} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px', marginBottom: '20px', flexWrap: 'wrap' }}>
                ...
                <div>
                  <h2 style={{ color: '#FAFAFA', fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 'clamp(1.25rem, 2.5vw, 1.6rem)', marginBottom: '4px' }}>
                    {p.name}
                  </h2>
              ...
              <p style={{ color: '#A1A1AA', lineHeight: 1.8, fontSize: '0.975rem', marginBottom: '24px' }}>{p.description}</p>

              <div style={{ marginBottom: '24px' }}>
                <p style={{ color: '#FAFAFA', fontSize: '0.8rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '12px' }}>
                  Self-Assessment Questions
                </p>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {p.questions.map((q, i) => (
                    <li key={i} style={{ display: 'flex', gap: '10px', color: '#71717A', fontSize: '0.9rem', lineHeight: 1.6 }}>
              ...
              <div style={{
                ...
                <p style={{ color: '#A1A1AA', fontSize: '0.875rem', lineHeight: 1.6, fontStyle: 'italic' }}>{p.scripture}</p>
              </div>
            </div>
          ))}
        </div>
